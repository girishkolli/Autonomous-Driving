...
class CarEnv(gym.Env):
	...
	def __init__(self):
		...
		self.cnn_model = load_model('C:\CARLA_0.9.15\WindowsNoEditor\PythonAPI\examples\model_saved_from_CNN.h5',compile=False)
	...
	def maintain_speed(self,s):
			...
			# function to maintan desired speed. s arg is actual current speed
